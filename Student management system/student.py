...
class Student():
      def __init__(self, root):
         ...
         title = Label(self.root,text="Student Management System" ,bd=9,relief=GROOVE, font=("times new roman",50,"bold"),bg="teal",fg="purple")
         ...
         m_title = Label(Manage_Frame,text="Manage Student", bg="#91c90c",fg="black",font=("times new roman",40,"bold"))
 ...
 #========== table frame ===========
      ...
      def add_students(self):
          if self.Roll_No_var.get()=="" or self.name_var.get()=="" :
             ...
             con=pymysql.connect(host="localhost" , user="root" , password="root", database="studentms")
             cur=con.cursor()
